 ...
 * @author Roman
 */
public class RepRegPensiones {

    /** Creates a new instance of Reporte */
    public RepRegPensiones(String titulo, String folio) {
        this.titulo = titulo;
        this.param = folio;
        prepararReporte();
    }
...
//            jasperviewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
    ...
    private void prepararReporte() {
        String paramRuta = "/proyectopare/clases/reportes/archivosjasper/ReportRegistroPensiones.jasper";
        rutaJasper = getClass().getResourceAsStream(paramRuta);
        parametros = new HashMap();

        parametros.put("PARAM_PROGRESIVO", new String(param));    //Insertar parametro para el query
