 ...
 * @author Roman
 */
public class RepAutosPernoctantes {

    /** Creates a new instance of Reporte */
    public RepAutosPernoctantes(String progresivoGeneral) {
        prepararReporte(progresivoGeneral);
    }
    ...
    public boolean crearReporteJRViewer() {
        ...
        try {
            ...
            jasperviewer.setTitle("Reporte de Autos Pernoctantes.");
...
//            jasperviewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
    ...
    private void prepararReporte(String progresivoGrl) {
        String paramRuta = "/proyectopare/clases/reportes/archivosjasper/ReportAutosPernoctantes2.jasper";
        rutaJasper = getClass().getResourceAsStream(paramRuta);
        parametros = new HashMap();

        parametros.put("PARAM_PROGRESIVO", new String(progresivoGrl));//Insertar parametro para el query
