 ...
 * @author Roman
 */
public class RepObjPrenda {

    /** Creates a new instance of Reporte */
    public RepObjPrenda(String titulo, String progresivoOP,String idParking) {
        this.titulo = titulo;
        this.param = progresivoOP;
...
//            jasperviewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
    ...
    private void prepararReporte() {
        String paramRuta = "/proyectopare/clases/reportes/archivosjasper/reporteObjetosPrenda.jasper";
        rutaJasper = getClass().getResourceAsStream(paramRuta);
        parametros = new HashMap();

        parametros.put("PARAM_PROGRESIVO_OP", new String(param));    //Insertar parametro para el query
        parametros.put("ID_PARKING", new Long(idParking));
