 ...
 * @author Roman
 */
public class RepAcuseDocs {

    /** Creates a new instance of Reporte */
    public RepAcuseDocs(String titulo, String folio) {
        this.titulo = titulo;
        this.param = folio;
        prepararReporte();
    }
...
//            jasperviewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
    ...
    private void prepararReporte() {
        String paramRuta = "/proyectopare/clases/reportes/archivosjasper/ReportAcuseDocumentos.jasper";
