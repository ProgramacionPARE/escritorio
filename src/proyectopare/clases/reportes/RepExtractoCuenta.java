 ...
 * @author Roman
 */
public class RepExtractoCuenta {

    /** Creates a new instance of Reporte */
    public RepExtractoCuenta(String idCliente,String fechaInicial, String fechaFinal) {
...
//            jasperviewer.setExtendedState(JasperViewer.MAXIMIZED_BOTH);
    ...
    private void prepararReporte() {
        String paramRuta = "/proyectopare/clases/reportes/archivosjasper/reporteExtractoCuenta.jasper";
        rutaJasper = getClass().getResourceAsStream(paramRuta);
        parametros = new HashMap();

        parametros.put("PARAM_ID", new Long(idCliente));
