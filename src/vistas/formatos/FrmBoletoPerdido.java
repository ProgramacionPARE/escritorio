...
public class FrmBoletoPerdido extends JDialog implements Printable {
    private Turno turno;
    private Auto auto;
    ...
    public FrmBoletoPerdido(javax.swing.JFrame padre, boolean b, Turno turno,Auto auto) {
        super(padre,b);
        this.turno = turno;
        this.auto = auto;
        this.parent = padre;
    ...
    public int print(Graphics g, PageFormat pageFormat, int page) throws PrinterException {
       ...
       Graphics2D g2d = (Graphics2D)g;
        ...
        g2d.transform(AffineTransform.getTranslateInstance(0,-190));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FrmBoletoPerdido.class);
        ...
        jLabel1.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText(resourceMap.getString("jLabel1.text")); // NOI18N
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel1.setName("jLabel1"); // NOI18N

        jLabel2.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText(resourceMap.getString("jLabel2.text")); // NOI18N
        jLabel2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel2.setName("jLabel2"); // NOI18N

        jLabel3.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText(resourceMap.getString("jLabel3.text")); // NOI18N
        jLabel3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel3.setName("jLabel3"); // NOI18N

        jLabel4.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText(resourceMap.getString("jLabel4.text")); // NOI18N
        jLabel4.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel4.setName("jLabel4"); // NOI18N

        jLabel5.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText(resourceMap.getString("jLabel5.text")); // NOI18N
        jLabel5.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel5.setName("jLabel5"); // NOI18N

        jLabel6.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText(resourceMap.getString("jLabel6.text")); // NOI18N
        jLabel6.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel6.setName("jLabel6"); // NOI18N

        jLabel7.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText(resourceMap.getString("jLabel7.text")); // NOI18N
        jLabel7.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel7.setName("jLabel7"); // NOI18N

        jLabel8.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText(resourceMap.getString("jLabel8.text")); // NOI18N
        jLabel8.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLabel8.setName("jLabel8"); // NOI18N

        jLabel9.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText(resourceMap.getString("jLabel9.text")); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N

        jLabel10.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        jLabel11.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel11.setText(resourceMap.getString("jLabel11.text")); // NOI18N
        jLabel11.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel11.setName("jLabel11"); // NOI18N

        jLabel12.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel12.setText(resourceMap.getString("jLabel12.text")); // NOI18N
        jLabel12.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel12.setName("jLabel12"); // NOI18N

        jLabel13.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel13.setText(resourceMap.getString("jLabel13.text")); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N

        jLabel14.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel14.setText(resourceMap.getString("jLabel14.text")); // NOI18N
        jLabel14.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jLabel14.setName("jLabel14"); // NOI18N

        txtFecha.setEditable(false);
        txtFecha.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtFecha.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtFecha.setBorder(null);
        txtFecha.setName("txtFecha"); // NOI18N

        txtNombrePropietario.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtDireccion.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtDireccion.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtDireccion.setBorder(null);
        txtDireccion.setName("txtDireccion"); // NOI18N

        txtTelefono.setColumns(12);
        txtTelefono.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtTelefono.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtTelefono.setText(resourceMap.getString("txtTelefono.text")); // NOI18N
        txtTelefono.setBorder(null);
        txtTelefono.setName("txtTelefono"); // NOI18N

        txtModelo.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtPlacas.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtPlacas.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtPlacas.setBorder(null);
        txtPlacas.setName("txtPlacas"); // NOI18N

        txtNoTarjCirculacion.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtNoTarjCirculacion.setBorder(null);
        txtNoTarjCirculacion.setName("txtNoTarjCirculacion"); // NOI18N

        txtProgresivo.setEditable(false);
        txtProgresivo.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        jLabel18.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        jLabel18.setText(resourceMap.getString("jLabel18.text")); // NOI18N
        jLabel18.setName("jLabel18"); // NOI18N

        txtCentroOperativo.setEditable(false);
        txtCentroOperativo.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtCentroOperativo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtCentroOperativo.setBorder(null);
        txtCentroOperativo.setName("txtCentroOperativo"); // NOI18N

        lblProgresivoPerdido.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtCaseta.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtCaseta.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtCaseta.setBorder(null);
        ...
        txtCajero.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtMarca.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        txtMarca.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtMarca.setBorder(null);
        txtMarca.setName("txtMarca"); // NOI18N

        txtTipoIdentificacion.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
        ...
        txtColor.setFont(resourceMap.getFont("txtTurno.font")); // NOI18N
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jLabel14)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(txtNoTarjCirculacion, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 554, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
            .add(jPanel1Layout.createSequentialGroup()
                .add(85, 85, 85)
                .add(jLabel16)
        ...
        if (validaCamposEntrada()){
            if(new Operacion().requierePermisos(turno.getEmpleado(), "Supervisor",true)){
                ...
                boletoPerdido = new BoletoPerdido(Long.valueOf(
                    Progresivo.getUltimoProgresivo(turno.getEmpleado().getCaseta(),
                        "PERDIDO")), auto, propietario,turno);
                Progresivo.setProgresivoMasUno(turno.getEmpleado().getCaseta(), "PERDIDO");
